...
return [
	...
	*/
	...
	'phone'                => 'فرمت شماره تلفن وارد شده اشتباه است.',
	'unique_array'         => 'گزینه :attribute دارای مقدار تکراری است (:values)',
	/*
	|--------------------------------------------------------------------------
	...
	*/
	...
	'attributes' => [
		FieldEnum::id->name                                                   => 'شناسه',
		FieldEnum::categoryId->name                                           => 'شناسه دسته بندی',
		FieldEnum::userId->name                                               => 'شناسه کاربر',
		FieldEnum::body->name                                                 => 'بدنه',
		FieldEnum::condition->name                                            => 'شرایط',
		FieldEnum::code->name                                                 => 'کد',
		FieldEnum::email->name                                                => 'ایمیل',
		FieldEnum::isValid->name                                              => 'معتبر است',
		FieldEnum::isDefault->name                                            => 'پیش فرض است',
		FieldEnum::name->name                                                 => 'نام',
		FieldEnum::phoneNumber->name                                          => 'شماره تلفن',
		FieldEnum::slug->name                                                 => 'نامک',
		FieldEnum::title->name                                                => 'عنوان',
		FieldEnum::label->name                                                => 'برچسب',
		FieldEnum::value->name                                                => 'مقدار',
		FieldEnum::createdAt->name                                            => 'تاریخ ایجاد',
		FieldEnum::deletedAt->name                                            => 'حذف شده در',
		FieldEnum::updatedAt->name                                            => 'به روز شده در',
		FieldEnum::verifiedAt->name                                           => 'تأیید شده در',
		FieldEnum::status->name                                               => 'وضعیت',
		FieldEnum::categories->name                                           => 'دسته‌ها',
		FieldEnum::mobileNumber->name                                         => 'شماره موبایل',
		FieldEnum::description->name                                          => 'توضیحات',
		FieldEnum::keyword->name                                              => 'کلمه کلیدی',
		FieldEnum::key->name                                                  => 'کلید',
		FilterField::onlyTrashed->name                                        => 'سطل آشغال',
		FilterField::withTrashed->name                                        => 'همراه با سطل آشغال',
	],
];
